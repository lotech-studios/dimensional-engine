...
class SimplexPlaneGeometry extends THREE.BufferGeometry {

	constructor ( 
        width = 1, height = 1, widthSegments = 1, heightSegments = 1,
        flat, simplex, simplexSX, simplexSY, simplexRX, simplexRY, simplexAmp,
		...
		for ( let iy = 0; iy < gridY1; iy ++ ) {
			...
			for ( let ix = 0; ix < gridX1; ix ++ ) {
                ...
                let height = flat ? 0 : ( Utils.Noise.simplexOctave( simplex, rX, rY, 16 ) - seaLevel ) * simAmp
...
SimplexPlaneGeometry.prototype.isSimplexPlaneGeometry = true

export { SimplexPlaneGeometry }