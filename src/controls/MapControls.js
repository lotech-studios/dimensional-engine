...
class MapControls extends EventDispatcher {
	...
	constructor ( object, domElement ) {
		...
		this.keyPanSpeed = 0.0125	// pixels moved per arrow key push
		...
		this.update = function () {
			...
			return function update () {
				...
				if ( scope.enableDamping ) {
					...
					scope.zoomStart += ( scope.zoomEnd - scope.zoomStart ) * scope.scrollDampingFactor
		...
		// make the panning methods public
		...
		function handleMouseWheel ( event ) {
			...
			if ( scope.enableZoom && scope.scrollDampingFactor > 0 ) {
	
				scope.zoomStart += ( event.wheelDelta / 40 ) * 0.001
